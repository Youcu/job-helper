...
MODULES = ["tests.test_merge", "tests.test_orchestrator", "tests.test_image_config", "tests.test_image_cache", "tests.test_image_fetch", "tests.test_image_slicing", "tests.test_image_reader", "tests.test_image_fill", "tests.test_image_process", "tests.test_filter"]
