...
MODULES = ["tests.test_merge", "tests.test_orchestrator", "tests.test_image_config", "tests.test_image_cache", "tests.test_image_fetch", "tests.test_image_slicing", "tests.test_image_reader", "tests.test_image_fill", "tests.test_image_process", "tests.test_filter", "tests.test_filter_words", "tests.test_jobplanet_rating", "tests.test_core_stack", "tests.test_history", "tests.test_career_words", "tests.test_career"]
